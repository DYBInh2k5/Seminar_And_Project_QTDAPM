...
5. [Phân tích thực tế triển khai: Khởi tạo và Quản trị Rủi ro dự án HSU (Nhóm 3)](#5-phân-tích-thực-tế-triển-khai-khởi-tạo-và-quản-trị-rủi-ro-dự-án-hsu-nhóm-3)
   - [5.1. Bối cảnh dự án & Bài toán tài chính](#51-bối-cảnh-dự-án--bài-toán-tài-chính-business-case)
   - [5.2. Danh sách 10 rủi ro ưu tiên của Dự án HSU](#52-danh-sách-10-rủi-ro-ưu-tiên-của-dự-án-hsu)
   - [5.3. Mẫu Điều Lệ Dự Án HSU (Project Charter)](#53-mẫu-điều-lệ-dự-án-hsu-project-charter)
   - [5.4. Sổ Theo Dõi Bên Liên Quan & Chiến Lược Quản Lý](#54-sổ-theo-dõi-bên-liên-quan--chiến-lược-quản-lý-stakeholder-register--strategy)
...
### 5.5. Hợp Đồng Làm Việc Nhóm HSU (Team Contract - Áp dụng mẫu Table 3-8 JWD)

Nhóm 3 đã xây dựng Hợp đồng Làm việc Nhóm (Team Contract) nhằm cam kết các nguyên tắc ứng xử, giao tiếp và giải quyết xung đột trong suốt vòng đời dự án:

*   **Quy tắc ứng xử (Code of Conduct):**
    *   Làm việc chủ động, dự báo trước các khó khăn kỹ thuật để cùng nhau tìm giải pháp ngăn chặn.
    *   Chia sẻ thông tin minh bạch, cập nhật mã nguồn thường xuyên trên repo GitHub chung.
    *   Đặt lợi ích chung và chất lượng của hệ thống lên hàng đầu.
*   **Nguyên tắc tham gia đóng góp (Participation):**
    *   Thành thật và cởi mở trong mọi ý kiến góp ý tại các buổi họp.
    *   Tạo cơ hội bình đẳng để mọi thành viên đều được đóng góp vào các quyết định quan trọng của hệ thống.
    *   Báo trước cho Project Manager Trần Bá Lợi ít nhất 24 giờ nếu có sự cố cá nhân hoặc có nguy cơ trễ hạn bàn giao (deadline).
*   **Quy chế giao tiếp (Communication):**
    *   Sử dụng Discord/Zalo làm kênh trao đổi nhanh, Trello để quản lý tiến độ thẻ tác vụ (tasks).
    *   PM Trần Bá Lợi chịu trách nhiệm điều phối các cuộc họp nhóm và gửi biên bản họp (meeting minutes).
    *   Hoàn thành cập nhật mã nguồn (pull request) và cập nhật tiến độ công việc trước 18:00 thứ 6 hàng tuần để PM tổng hợp báo cáo.
*   **Giải quyết vấn đề & Xung đột (Problem Solving):**
    *   Khuyến khích mọi thành viên cùng brainstorm đưa ra giải pháp khi có sự cố.
    *   Chỉ phê bình mang tính xây dựng, tập trung vào cách sửa lỗi hệ thống (code/design review) chứ không đổ lỗi cho cá nhân.
*   **Nguyên tắc họp hành (Meeting Guidelines):**
    *   Họp định kỳ qua Google Meet vào lúc 20:00 tối thứ 4 hàng tuần.
    *   Mỗi cuộc họp kéo dài không quá 45 phút, tập trung thảo luận giải quyết khó khăn và phân công sprint tiếp theo.

---

### 5.6. Các Bài Học Ứng Phó Rủi Ro Thực Tế Trong Quá Trình Thi Công
...
### 5.7. Cấu trúc WBS (Figure 3-3) & Phân định Phạm vi giữa Seminar và Project
...
### 6.1. Báo cáo Bài học Kinh nghiệm HSU (Lessons-Learned Report - Áp dụng mẫu Table 3-16 JWD)

Dưới đây là Báo cáo Bài học Kinh nghiệm tổng kết dự án Cổng Đăng ký Học phần HSU của Nhóm 3:

| Câu hỏi tổng kết (Evaluation Questions) | Nội dung đánh giá thực tế của Nhóm 3 |
| :--- | :--- |
| **1. Dự án có đạt được các mục tiêu về phạm vi, thời gian và chi phí không?** | Dự án đạt 100% mục tiêu phạm vi (đầy đủ các cổng nghiệp vụ và dashboard tiến độ) và đúng thời gian bàn giao (15/08/2026). Chi phí thực tế vượt $10,000 do quyết định mua thư viện kiểm tra trùng lịch học chất lượng cao để đảm bảo an toàn tiến độ. |
| **2. Tiêu chí thành công ban đầu ghi nhận trong Scope Statement là gì?** | Hệ thống phải xử lý đăng ký môn học ổn định với tải mô phỏng 500 sinh viên truy cập đồng thời, phản hồi nhanh dưới 1.5 giây, check trùng lịch học chính xác 100%, và giúp Phòng Đào tạo tiết kiệm 90% công sức kiểm tra học vụ thủ công. |
| **3. Đội ngũ đã thực hiện đạt tiêu chí thành công chưa?** | Đã đạt hoàn toàn. Trải nghiệm stress test thực tế đạt tải yêu cầu, giải quyết dứt điểm các trường hợp trùng lịch học và môn tiên quyết. Khảo sát sinh viên cho thấy độ hài lòng đạt 95%. |
| **4. Các bài học kinh nghiệm cốt lõi rút ra là gì?** | • **Hợp tác bất đồng bộ:** Cho phép các thành viên làm việc độc lập theo milestone (như thiết kế UI của Quang) giúp tăng năng suất đáng kể. <br>• **Quản trị rủi ro chủ động:** Nhận diện sớm rủi ro sập tải giúp nhóm thiết lập Redis Caching ngay từ đầu. <br>• **Sử dụng giải pháp sẵn có:** Việc mua thư viện check lịch học ngoài giúp tránh việc "tự chế bánh xe" gây trễ hạn tiến độ. |
| **5. Ví dụ cụ thể về những gì làm tốt và chưa tốt?** | • **Làm tốt:** Tích hợp thành công thuật toán CPM tìm đường găng tiến độ lên dashboard quản trị cực kỳ trực quan. <br>• **Chưa tốt:** Giai đoạn đầu thiết lập API backend và frontend chưa thống nhất tài liệu đặc tả dẫn đến mất 2 ngày sửa lỗi định dạng JSON. |

### 6.2. Kết luận tổng quan

Việc kết hợp chặt chẽ giữa các công cụ hoạch định khởi tạo (Project Charter, Stakeholder Strategy, Kick-off Agenda) và các tài liệu nguyên tắc đồng thuận nhóm (Team Contract) chính là nền tảng cốt lõi giúp Nhóm 3 xây dựng thành công Hệ thống Đăng ký Học phần HSU đúng tiến độ đề ra, bảo đảm sự bền vững của dự án trước các biến động và rủi ro rình rập.