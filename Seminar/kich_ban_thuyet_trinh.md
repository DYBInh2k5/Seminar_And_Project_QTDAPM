# KỊCH BẢN THUYẾT TRÌNH SEMINAR (LẦN 1) - THEO TRÌNH TỰ SLIDE
...
🎙️ **Người trình bày: VÕ DUY BÌNH**
*   **Nội dung trên slide:** Tên đề tài bằng tiếng Anh, Thông tin lớp học, Danh sách thành viên nhóm 3.
*   **Lời thoại nói:**
    > "Lời đầu tiên, em xin đại diện nhóm 3 gửi lời chào đến thầy và toàn thể các bạn lớp Quản trị dự án phần mềm. Hôm nay, nhóm chúng em xin trình bày chuyên đề Seminar phần 1 với đề tài: **'Risk and Schedule Management in the Online Course Registration System Construction Project'**. 
    > 
...
🎙️ **Người trình bày: VÕ DUY BÌNH**
*   **Nội dung trên slide:** Định nghĩa rủi ro theo PMBOK, 6 bước quy trình quản trị rủi ro, bảng so sánh đặc thù dự án xây dựng với dự án phần mềm.
*   **Lời thoại nói:**
    > "Để bắt đầu, chúng ta cần thống nhất định nghĩa về rủi ro theo chuẩn PMBOK. Rủi ro dự án là một sự kiện hoặc điều kiện chưa chắc chắn, nếu xảy ra sẽ tác động tiêu cực hoặc tích cực đến các mục tiêu cốt lõi như tiến độ, ngân sách hoặc chất lượng. 
    > 
...
🎙️ **Người trình bày: VÕ DUY BÌNH**
*   **Nội dung trên slide:** Giao diện tab tương tác hiển thị hai nhóm rủi ro: Biến động thị trường bên ngoài và Hiệu quả dòng tiền bên trong.
*   **Lời thoại nói:**
    > "Tiếp theo, em xin đi sâu vào hai nhóm rủi ro đầu tiên của dự án: Rủi ro thị trường và Rủi ro tài chính. 
    > 
    ...
    > 
    > Sau đây, em xin nhường phần thuyết trình lại cho bạn Thanh Quang để tiếp tục với mô hình SWOT và rủi ro công nghệ, con người."

---

### 🖥️ Slide 4: Mô hình SWOT Nhận Diện Rủi Ro - Dự Án HSU
🎙️ **Người trình bày: NGUYỄN THANH QUANG**
*   **Nội dung trên slide:** Ma trận SWOT phân tích dự án Cổng đăng ký môn học trên di động HSU.
*   **Lời thoại nói:**
    > "Xin chào thầy và các bạn, em là Thanh Quang. Tiếp theo phần trình bày của bạn Bình, em xin giới thiệu về mô hình SWOT mà nhóm đã xây dựng riêng cho dự án Đăng ký học phần di động của sinh viên HSU. 
    > 
...
🎙️ **Người trình bày: NGUYỄN THANH QUANG**
*   **Nội dung trên slide:** Lưới 4 thẻ rủi ro kỹ thuật: Chọn sai công nghệ, Lỗi bảo mật (OWASP 2025), Không mở rộng được hệ thống (Scalability), Nợ kỹ thuật (Technical Debt).
*   **Lời thoại nói:**
    > "Đối với một dự án phần mềm, rủi ro công nghệ luôn là rủi ro cốt lõi. Chúng em nhận diện 4 rủi ro lớn nhất:
    > 
...
🎙️ **Người trình bày: NGUYỄN THANH QUANG**
*   **Nội dung trên slide:** Lưới 4 thẻ rủi ro nhân sự: Thiếu nhân lực, Thành viên nghỉ việc, Thiếu kỹ năng chuyên môn, Giao tiếp kém trong nhóm.
*   **Lời thoại nói:**
    > "Song song với công nghệ, con người là nhân tố quyết định thành bại của dự án. 
    > 
...
🎙️ **Người trình bày: NGUYỄN THANH QUANG**
*   **Nội dung trên slide:** Phân tích 4 vụ bê bối IT lịch sử: Equifax (2017), Healthcare.gov (2013), Knight Capital (2012), FBI Trilogy (2005).
*   **Lời thoại nói:**
    > "Để chứng minh cho các rủi ro trên không chỉ là lý thuyết, em xin trình bày 4 case study xương máu trong lịch sử CNTT thế giới:
    > 
    ...
    > 
    > Tiếp theo, bạn Trần Bá Lợi sẽ trình bày phần Lập kế hoạch ứng phó rủi ro."

---

### 🖥️ Slide 8: Lập Kế Hoạch Ứng Phó Rủi Ro & Tích Hợp SDP
🎙️ **Người trình bày: TRẦN BÁ LỢI**
*   **Nội dung trên slide:** 4 chiến lược ứng phó rủi ro PMBOK (Avoid, Mitigate, Transfer, Accept), Bản đăng ký rủi ro (Risk Response Register) và tích hợp vào tài liệu kế hoạch phần mềm SDP.
*   **Lời thoại nói:**
    > "Xin chào thầy và các bạn, em là Trần Bá Lợi. Sau khi đã nhận diện các rủi ro kỹ thuật và nhân sự ở trên, em xin trình bày các phương án lập kế hoạch ứng phó cụ thể. 
    > 
    ...
    > 
    > Sau đây, bạn Hồng Bảo Khang sẽ trình bày về phần Lý thuyết Hữu dụng rủi ro."

---

### 🖥️ Slide 9: Lý Thuyết Hữu Dụng Của Rủi Ro (Risk Utility Theory)
🎙️ **Người trình bày: HỒNG BẢO KHANG**
*   **Nội dung trên slide:** Khái niệm Utility (Hữu dụng), 3 nhóm thái độ rủi ro (Risk-averse, Risk-neutral, Risk-seeking) và hình học hàm thỏa dụng (Lõm, Tuyến tính, Lồi).
*   **Lời thoại nói:**
    > "Xin chào thầy và các bạn, em tên là Hồng Bảo Khang. Em xin trình bày phần nội dung mang tính học thuật của Seminar chuyên đề lần này: **Lý thuyết Hữu dụng Rủi ro (Risk Utility Theory)**. 
    > 
...
🎙️ **Người trình bày: HỒNG BẢO KHANG**
*   **Nội dung trên slide:** Đồ thị SVG tương tác thực tế hiển thị 3 đường cong hữu dụng (Lõm hồng, Tuyến tính xanh, Lồi tím) và thanh trượt thay đổi giá trị tài sản $x$.
*   **Lời thoại nói:**
    > "Mời thầy và các bạn theo dõi phần biểu diễn mô phỏng đồ thị tương tác thời gian thực trên màn hình. 
    > 
    ...
    > 
    > Tiếp theo, bạn Trần Bá Lợi sẽ quay lại trình bày phần Phân tích hiệu quả tài chính và rủi ro đầu tư."
...
🎙️ **Người trình bày: HỒNG BẢO KHANG**
*   **Nội dung trên slide:** Các thông số thực tế của dự án mẫu JWD Consulting, 5 bài học kinh nghiệm cốt lõi và slide mở đầu Q&A.
*   **Lời thoại nói:**
    > "Để đúc kết lại toàn bộ chuyên đề Seminar 1, chúng em đối chiếu với dự án thực tế của JWD Consulting (Chương 3 sách Kathy Schwalbe):
